"""azydes_20771 URL Configuration
...
admin.site.site_header = "Azydes"
admin.site.site_title = "Azydes Admin Portal"
admin.site.index_title = "Azydes Admin"

# swagger
api_info = openapi.Info(
    title="Azydes API",
    default_version="v1",
    description="API documentation for Azydes App",
)
